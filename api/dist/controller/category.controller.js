...
const handleBulkDeleteCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { ids } = req.body;
        const result = yield (0, categoryService_1.deleteCategoryByIds)(ids);
...
const handleGetCategoryId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield (0, categoryService_1.getCategoryById)(id);
        if (!data) {
            res.status(404).json({
                success: false,
...
const handleUpdateCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updated = yield (0, categoryService_1.updateCategoryById)(id, data);
        if (!updated) {
            res.status(404).json({
                success: false,
                message: 'Category not found'
